...
class RedisStore implements Store
{
     ...
     * @return void
     */
    public function put($key, $value, $units)
    {
        $seconds = $this->getUnitSeconds($units);
     ...
     * @return void
     */
    public function putMany(array $values, $units)
    {
        $this->connection()->multi();

        foreach ($values as $key => $value) {
            $this->put($key, $value, $units);
        }
     ...
     * @return bool
     */
    public function add($key, $value, $units)
    {
        $seconds = $this->getUnitSeconds($units);
